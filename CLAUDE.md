...
| `folder/` | `core.py` | `create_folder`, `update_folder`, `get_folder_id`, `get_folders` (structure param, default `"flat"`), `get_navver`, `delete_folder`; deprecated: `get_folder_ancestors`→get_folders, `get_all_folders`→get_folders(structure="tree") |
