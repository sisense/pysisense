...
| `dashboard/` | `Dashboard` | Dashboard CRUD, share management, script injection |
...
| `dashboard/` | `core.py` | `get_all_dashboards`, `get_dashboard_by_id`, `get_dashboard_by_name`, `resolve_dashboard_reference` |
| | `shares.py` | `add_dashboard_shares`, `get_dashboard_share` |
| | `columns.py` | `get_dashboard_columns` |
| | `scripts.py` | `add_dashboard_script`, `add_widget_script`, `extract_scripts`, `extract_scripts_from_all_dashboards` |
